...
<section class="shopping-cart">
    ...
    ?>
    <div  class="box">
        <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('hapus item ini dari keranjang?');"></a>
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('hapus semua dari keranjang?');">Kosongkan Keranjang </a>
    </div>

    <div class="cart-total">
        <p>Total Keseluruhan : <span>Rp. <?php echo $grand_total; ?>/-</span></p>
        <a href="shop.php" class="option-btn">Lanjut Belanja</a>
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Konfirmasi</a>
    </div>
