...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="perbarui nama produk" name="name">
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" required placeholder="perbarui harga produk" name="price">
   <textarea name="details" class="box" required placeholder="perbarui detail produk" cols="30" rows="10"><?php echo $fetch_products['details']; ?></textarea>
...
<?php
      ...
      echo '<p class="empty">Tidak ada produk yang dipilih untuk diperbarui</p>';
   }
?>
